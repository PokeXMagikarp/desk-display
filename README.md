...
|-----|----------|-------------|-----|----------|----------|-------------|
| LED display | [link](https://www.digikey.com.au/en/products/detail/lumimax-optoelectronic-technology/LED10WHI/29263557)    | Picture Display | 256|  270 | .17 | 35.1 |
...
originally i was planning on using these [LEDs](https://www.digikey.com.au/en/products/detail/luckylight/KWM-20881AVA/14009060) but i would have needed to buy 100 of them for a 200x200mm display which would have been 120 bucks. the LEDs are actually quite expensive. 

i chose to use a smaller display with less resolution. 16x16 pixels using 10mm diameter leds which would be $35.1 for a 160x160mm screen.

now i just need to design a multiplexer board for the screen.
